...
import { API_BASE, getCropUrl, getMediaUrl, safeFetch } from '@/utils/api';
...
export default function ReportPage() {
    ...
    // Use secure utility functions from @/utils/api for path sanitization
    // getCropUrl and getMediaUrl are imported from the utility module
